 ...
 *
 * -----------------------------------------------------------------
 * Sensory TrulyNatural SDK: datalocations.h
...
/* Avoid unwanted substitutions in DATADIR_SAMP and DATADIR_SDK paths */
#ifdef linux
# undef linux
# define linux linux
#endif
...
#ifndef DATADIR_SAMP
# define DATADIR_SAMP /etc
#endif

#ifndef DATADIR_SDK
# define DATADIR_SDK DATADIR_SAMP/../../../Data
#endif

#if 1
/*------------ 16kHz large vocabulary language data ----------*/
# define LVCSR_LANGDIR en_us_16kHz_v11
# define NETFILE_LVCSR_3_500 "nn_en_us_fbank_16k_3_500_v12.0.2.raw"
# define NETFILE_LVCSR_4_1000 "nn_en_us_fbank_16k_4_1000_v12.0.3.raw"
# define NETFILE_LVCSR_5_1000 "nn_en_us_fbank_16k_5_1000_v12.0.4.raw"
# define LTSFILE_LVCSR "lts_en_us_12.6.9.raw"
#endif
...
#define THF_DATADIR     _STR(DATADIR_SDK) "/" _STR(LANGDIR) "/"
#define THF_TTSDIR      _STR(DATADIR_SDK) "/" _STR(TTSDIR)  "/"
#define SAMPLES_DATADIR _STR(DATADIR_SAMP) "/"

#define THF_LVCSR_DATADIR _STR(DATADIR_SDK) "/" _STR(LVCSR_LANGDIR) "/"

#define STATIC_DEF(_a_,_b_) <DATADIR_SDK/_a_/_b_.c>
